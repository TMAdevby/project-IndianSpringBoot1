...
CREATE TABLE `employees_projects` (
  ...
  KEY `FK68nqq5pnqm9cp4251y8wfjfy1` (`fk_project`),
  KEY `FKki3d6fv32kdbv9v0apmalhcos` (`fk_employee`),
  CONSTRAINT `FK68nqq5pnqm9cp4251y8wfjfy1` FOREIGN KEY (`fk_project`) REFERENCES `project` (`id`),
  CONSTRAINT `FKki3d6fv32kdbv9v0apmalhcos` FOREIGN KEY (`fk_employee`) REFERENCES `employees` (`id`)
...
INSERT INTO `employees_projects` VALUES (11,7),(11,8);
