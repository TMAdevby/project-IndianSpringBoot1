...
CREATE TABLE `employees_address` (
  ...
  UNIQUE KEY `UK_l56xlid2mbvrpixoaa10in432` (`address_id`),
  KEY `FKc5pevnniuh43l0o8ber0j0r76` (`employee_id`),
  CONSTRAINT `FKc5pevnniuh43l0o8ber0j0r76` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`),
  CONSTRAINT `FKlvynmxa6i7a6uskgmxiec4w86` FOREIGN KEY (`address_id`) REFERENCES `address` (`id`)
...
INSERT INTO `employees_address` VALUES (11,7),(11,8);
